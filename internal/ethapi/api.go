...
func DoEstimateGas(ctx context.Context, b Backend, args TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, overrides *StateOverride, gasCap uint64) (hexutil.Uint64, error) {
	...
	arbState := arbitrum_core.New(state)
...
// transaction hashes.
func RPCMarshalBlock(block *types.Block, inclTx bool, fullTx bool, config *params.ChainConfig, arbState *arbitrum_core.ArbState) map[string]interface{} {
...
// a `BlockchainAPI`.
func (s *BlockChainAPI) rpcMarshalBlock(ctx context.Context, b *types.Block, inclTx bool, fullTx bool, arbState *arbitrum_core.ArbState) (map[string]interface{}, error) {
...
func newRPCTransaction(tx *types.Transaction, blockHash common.Hash, blockNumber uint64, blockTime uint64, index uint64, baseFee *big.Int, config *params.ChainConfig, arbState *arbitrum_core.ArbState) *RPCTransaction {
...
func newRPCTransactionFromBlockIndex(b *types.Block, index uint64, config *params.ChainConfig, arbState *arbitrum_core.ArbState) *RPCTransaction {
	txs := b.Transactions()
